export default {
  ...
  ddos: {
    ...
    successBar: {
      title: 'Статистика успішних реквестів',
      restartVpn: 'Відсоток успішних реквестів менше 10, рекомендуємо змінити IP',
      keepVpn: 'Успішних реквестів достатньо для продовження використання цього IP'
    }
  }
}
